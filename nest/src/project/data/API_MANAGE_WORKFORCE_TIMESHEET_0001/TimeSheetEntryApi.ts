...
> implements EntityApi<TimeSheetEntry<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    ...
    TIME_SHEET_OPERATION: OrderableEdmTypeField<
      ...
      true
    >;
    YY_1_HEURE_DEBUT_TIM: OrderableEdmTypeField<
      TimeSheetEntry<DeSerializers>,
      DeSerializersT,
      'Edm.Time',
      true,
      true
    >;
    YY_1_HEURE_DEBUT_TIMF: OrderableEdmTypeField<
      TimeSheetEntry<DeSerializers>,
      DeSerializersT,
      'Edm.Byte',
      true,
      true
    >;
    YY_1_HEURE_FIN_TIM: OrderableEdmTypeField<
      TimeSheetEntry<DeSerializers>,
      DeSerializersT,
      'Edm.Time',
      true,
      true
    >;
    YY_1_HEURE_FIN_TIMF: OrderableEdmTypeField<
      TimeSheetEntry<DeSerializers>,
      DeSerializersT,
      'Edm.Byte',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link yy1HeureDebutTim} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        YY_1_HEURE_DEBUT_TIM: fieldBuilder.buildEdmTypeField(
          'YY1_HeureDebut_TIM',
          'Edm.Time',
          true
        ),
        /**
         * Static representation of the {@link yy1HeureDebutTimf} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        YY_1_HEURE_DEBUT_TIMF: fieldBuilder.buildEdmTypeField(
          'YY1_HeureDebut_TIMF',
          'Edm.Byte',
          true
        ),
        /**
         * Static representation of the {@link yy1HeureFinTim} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        YY_1_HEURE_FIN_TIM: fieldBuilder.buildEdmTypeField(
          'YY1_HeureFin_TIM',
          'Edm.Time',
          true
        ),
        /**
         * Static representation of the {@link yy1HeureFinTimf} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        YY_1_HEURE_FIN_TIMF: fieldBuilder.buildEdmTypeField(
          'YY1_HeureFin_TIMF',
          'Edm.Byte',
          true
        ),
