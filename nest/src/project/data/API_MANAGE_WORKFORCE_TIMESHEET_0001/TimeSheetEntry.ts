  ...
  implements TimeSheetEntryType<T>
{
   ...
   * @nullable
   */
  declare yy1HeureDebutTim?: DeserializedType<T, 'Edm.Time'> | null;
  /**
   * UI Field Control.
   * @nullable
   */
  declare yy1HeureDebutTimf?: DeserializedType<T, 'Edm.Byte'> | null;
  /**
   * Heure Fin.
   * @nullable
   */
  declare yy1HeureFinTim?: DeserializedType<T, 'Edm.Time'> | null;
  /**
   * UI Field Control.
   * @nullable
   */
  declare yy1HeureFinTimf?: DeserializedType<T, 'Edm.Byte'> | null;
...
> {
  ...
  yy1HeureDebutTim?: DeserializedType<T, 'Edm.Time'> | null;
  yy1HeureDebutTimf?: DeserializedType<T, 'Edm.Byte'> | null;
  yy1HeureFinTim?: DeserializedType<T, 'Edm.Time'> | null;
  yy1HeureFinTimf?: DeserializedType<T, 'Edm.Byte'> | null;
}
